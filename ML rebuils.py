...
if __name__ == "__main__":
  ...
  #  Y_train_scale = Y_train / X_max
   ...
   # model = load_model('TL12-Proposed Model- for TTL-6- 128ep_tl12.h5', custom_objects={'Attention': Attention})
    model = load_model('TL3-CheckLSTM-DNN for TTL-3- 80ep_tl3.h5')
    model.summary()
  ...
  #  aa = [x for x in range(350)]
    ...
    plt.plot( y_true[:, 0, :100], 'b', marker='.')
    plt.plot( Y_pred_test[:, 0, :100], 'r')
